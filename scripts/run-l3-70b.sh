#!/bin/bash
# Profile Meta-Llama-3-70B-Instruct with all speculative decoding methods,
...
for dataset in instructcoder cnndailymail sharegpt gsm8k; do
    for method in none ngram eagle; do
...
python vis_speedup.py --results_dir "$output_dir" --model_key llama3-70b
